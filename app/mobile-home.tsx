  ...
  useEffect(()=>{
    ...
    const render=()=>{
      ...
      if(!heatSource){
        ...
        map.addLayer({id:"mobile-venue-glow",type:"heatmap",source:"mobile-venue-heat",maxzoom:14,paint:{"heatmap-weight":["interpolate",["linear"],["get","score"],0,.25,40,.6,70,.9,100,1],"heatmap-intensity":["interpolate",["linear"],["zoom"],7,1.45,10,1.75,13,1.05],"heatmap-radius":["interpolate",["linear"],["zoom"],7,38,10,58,13,38],"heatmap-opacity":["interpolate",["linear"],["zoom"],7,.86,10,.76,12,.56,14,0],"heatmap-color":["interpolate",["linear"],["heatmap-density"],0,"rgba(0,0,0,0)",.06,"rgba(34,145,255,.34)",.2,"rgba(39,217,171,.54)",.4,"rgba(255,214,64,.72)",.66,"rgba(255,126,32,.88)",1,"rgba(255,45,60,1)"]}});
      }
      if(!pinSource){
