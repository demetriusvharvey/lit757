          ...
          <>
              ...
              <div className="mt-7 space-y-2">
                {providers.google && (
                  <button
                    ...
                    className="flex h-12 w-full items-center justify-center rounded-full border border-black/[0.1] bg-white text-[13px] font-semibold text-black/76 transition hover:border-black/22 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#ff5c35]"
                  >
                ...
                {providers.apple && (
                  <button
                    ...
                    className="flex h-12 w-full items-center justify-center rounded-full bg-[#171716] text-[13px] font-semibold text-white transition hover:bg-black focus:outline-none focus-visible:ring-2 focus-visible:ring-[#ff5c35]"
                  >
                    Continue with Apple
                  </button>
                )}
            ...
            {providers.email && (
              <form onSubmit={submitEmail} className="mt-3 space-y-2">
                ...
                >
                  {working && <LoaderCircle size={15} className="animate-spin" />}
