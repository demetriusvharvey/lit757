...
export const BUZZ_INTEGRATIONS: IntegrationDefinition[] = [
  ...
  { id: "eventbrite", name: "Eventbrite", category: "Events & calendars", state: "conditional", role: "forecast-context", detail: "The production private token authenticates but exposes zero organizations, so it contributes no events. Official broad public regional discovery requires Eventbrite distribution-partner approval; unofficial page scraping is disabled.", env: ["EVENTBRITE_PRIVATE_TOKEN"] },
