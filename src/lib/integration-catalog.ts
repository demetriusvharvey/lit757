...
export const BUZZ_INTEGRATIONS: IntegrationDefinition[] = [
  ...
  { id: "besttime", name: "BestTime", category: "Maps & venue intelligence", state: "partial", role: "direct-evidence", detail: "Private-key live requests and public-key forecast lookups are wired. Only provider-confirmed live readings count as direct evidence; forecast readings remain capped context while venue coverage is validated.", env: ["BESTTIME_API_KEY_PRIVATE", "BESTTIME_API_KEY_PUBLIC"] },
