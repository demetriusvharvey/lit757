...
export const BUZZ_INTEGRATIONS: IntegrationDefinition[] = [
  ...
  { id: "besttime", name: "BestTime", category: "Maps & venue intelligence", state: "needs-key", role: "direct-evidence", detail: "Live foot-traffic and forecast busyness for mapped venues. Only provider-confirmed live readings count as direct evidence; forecast readings remain capped context.", env: ["BESTTIME_API_KEY_PRIVATE"] },
